...
public class MultiPhotoSelectActivity extends Activity {
	...
	public void btnChoosePhotosClick(View v) {
		new ResizeImagesTask(this, imageAdapter.getCheckedItems())
				.execute(new Void[0]);
		/*
		 * ArrayList<String> selectedItems = imageAdapter.getCheckedItems();
		 * Toast.makeText(MultiPhotoSelectActivity.this,
		 * "Total photos selected: " + selectedItems.size(), Toast.LENGTH_SHORT)
		 * .show(); Log.d(MultiPhotoSelectActivity.class.getSimpleName(),
