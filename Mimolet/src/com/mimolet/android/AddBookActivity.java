...
public class AddBookActivity extends SherlockFragmentActivity {
    ...
    final ImageView rightImage = (ImageView) stylePageFragment.getView()
		...
		final File imageFolder = new File(GalleryPhotoFragment.IMAGE_FOLDER);
		stylePageFragment.setImagePathes(imageFolder.list());
		ImageUtils.loadImage(bookCover, GalleryPhotoFragment.IMAGE_FOLDER
    ...
    final ImageView rightImage = (ImageView) stylePageFragment.getView()
        .findViewById(R.id.rightImage);
    ImageUtils.loadImage(leftImage, GalleryPhotoFragment.IMAGE_FOLDER
        + stylePageFragment.getLeftImagePath());
    ImageUtils.loadImage(rightImage, GalleryPhotoFragment.IMAGE_FOLDER
