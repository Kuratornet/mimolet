...
public class PreviewFragment extends Fragment {
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    ...
    final ImageButton createPDF = (ImageButton) view.findViewById(R.id.checkoutButton);
    createPDF.setOnClickListener(new OnClickListener() {
      ...
      public void onClick(View arg0) {
        ...
        final String targetFile =
            GlobalVariables.MIMOLET_FOLDER + "Images.pdf";
        final String previewFile =
            GlobalVariables.MIMOLET_FOLDER + "preview.png";
        try {
          ...
          final Bitmap previewBitmap = ImageUtils.decodeSampledBitmapFromFile(GlobalVariables.IMAGE_FOLDER + previewUrl, 200, 200, false);
          ...
          for (File file : listOfFiles) {
            String imageName = GlobalVariables.IMAGE_FOLDER + file.getName();
            final Bitmap bitmap = ImageUtils.decodeSampledBitmapFromFile(imageName, SIDE_SIZE, SIDE_SIZE, false);
        ...
        new SendPDFTask(getActivity(), targetFile, previewFile, order).execute(new Void[0]);
      }
    });
    return view;
  }
