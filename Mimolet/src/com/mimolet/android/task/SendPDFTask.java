...
public class SendPDFTask extends AsyncTask<Void, Void, Void> {
	...
	public SendPDFTask(Activity context, String filePath, String previewPath,
			Order order) {
	...
	protected Void doInBackground(Void... arg0) {
		...
		try {
			...
			while ((line = rd.readLine()) != null) {
				Log.v(TAG, line);
				File pdfFile = new File(GlobalVariables.MIMOLET_FOLDER
						+ "Images.pdf");
				pdfFile.delete();

				File previewFile = new File(GlobalVariables.MIMOLET_FOLDER
						+ "preview.png");
				previewFile.delete();
			}
